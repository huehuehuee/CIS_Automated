...
# 18.9.39.1.1 (L2) Ensure 'Turn off Windows Location Provider' is set to 'Enabled'
audit-check -testName "18.9.39.1.1 (L2) Ensure 'Turn off Windows Location Provider' is set to 'Enabled'" -pathName "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" -keyName "DisableWindowsLocationProvider" -successCondition 1 -operator "eq"
...
# 18.9.60.3 (L2) Ensure 'Set what information is shared in Search' is set to 'Enabled: Anonymous info'
audit-check -testName "18.9.60.3 (L2) Ensure 'Set what information is shared in Search' is set to 'Enabled: Anonymous info'" -pathName "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search" -keyName "ConnectedSearchPrivacy" -successCondition 3 -operator "eq"
...
Write-Host "The next checks requires retrieval of user SID. Unable to automate without context?"
